...
public class CoreGameLogic : MonoBehaviour
{
    ...
    public void InteractWithPC()
    {
        ...
        // --- UPDATED: Smooth Loading Screen Use Ki Hai ---
    ...
    // --- NEW LOGIC: Master Loading Screen System ---
    ...
    IEnumerator LoadingScreenRoutine(string sceneName)
    {
        ...
        canvas.sortingOrder = 99999; // Sab se top par
        DontDestroyOnLoad(canvasObj); // Scene change hone par delete na ho

        // 1. Black Background (Foran)
        ...
        // 4. Load Scene in Background (Async)
        AsyncOperation asyncLoad = SceneManager.LoadSceneAsync(sceneName);
        
        // Jab tak scene load ho raha hai, screen dikhti rahegi
        while (!asyncLoad.isDone)
        {
            yield return null;
        }

        // 5. Jaise hi naya scene aayega, Loading Canvas destroy ho jayega
        Destroy(canvasObj);
    }
    ...
    IEnumerator ShowSavageFailScreen()
    {
        ...
        // --- UPDATED: Savage Fail ke baad MainMenu bhi smooth load hoga ---
